...
<body>
	<div class="main">
		...
		<div class="body">
			<form action="BasicInfoServlet?opt=updateInfo" method="post">
				<table align="center" cellspacing="0">
					...
					<c:forEach items="${userInfo }" var="userInfo">
						<tr>
							<td><font>用户名：</font></td>
							<td><input type="text" value="${userInfo.stuName }"
								name="StuName" readonly="readonly"/></td>
							<td><font>*</font>(不可修改)</td>
						</tr>
						<tr>
							<td><font>学号：</font></td>
							<td><input type="text" value="${userInfo.card }"
						...
						<tr>
							...
							<td><input type="text" value="${userInfo.userTel }"
								name="UserTel" /></td>
